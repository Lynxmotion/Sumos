'Program name: basumo14.bas for Basic Atom 28.
...
adin AX0,2,ad_ron,LeftOpDetect
adin AX1,2,ad_ron,RightOpDetect
...
LeftMotor = 1000	'Forward, full speed
RightMotor = 1000	'Reverse, full speed
gosub ServoPulses
next
for aa=1 to 80		'Arc Left (gradual turn)
LeftMotor = 1350	'Forward, slow
...
adin AX0,2,ad_ron,LeftOpDetect	'Opponent Detection
adin AX1,2,ad_ron,RightOpDetect
...
next
for aa=1 to Turn
LeftMotor = 1000	'Reverse, full speed
RightMotor = 1000	'Forward, full speed
gosub ServoPulses
next
goto Main
